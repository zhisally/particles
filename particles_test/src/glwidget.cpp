...
void GLWidget::initializeGL() {
    ...
    std::vector<GLfloat> quadData = {-1.0f,1.0f,0.0f,0.0f,1.0f,\
...
void GLWidget::drawBlur() {
    ...
    GLint projectionLoc = glGetUniformLocation(m_phongProgram, "projection");
    GLint modelLoc = glGetUniformLocation(m_phongProgram, "model");
    glUniformMatrix4fv(viewLoc, 1, false, glm::value_ptr(m_view));
    glUniformMatrix4fv(projectionLoc, 1, false, glm::value_ptr(m_projection));
    glUniformMatrix4fv(modelLoc, 1, false, glm::value_ptr(glm::translate(glm::vec3(0.0f, 1.2f, 0.0f))));
...
void GLWidget::drawParticles() {
    ...
    GLint numPartsLoc = glGetUniformLocation(m_particleUpdateProgram, "numParticles");
    glUniform1i(numPartsLoc,m_numParticles);
    GLint prevPosLoc = glGetUniformLocation(m_particleUpdateProgram, "prevPos");
    glUniform1i(prevPosLoc,0);
    GLint prevVelPos = glGetUniformLocation(m_particleUpdateProgram, "prevVel");
    glUniform1i(prevVelPos,1);
    m_quad->draw();
    ...
    GLint numParts2Loc = glGetUniformLocation(m_particleDrawProgram, "numParticles");
    glUniform1i(numParts2Loc, m_numParticles);
